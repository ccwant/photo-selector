 ...
 * @since 1.9.2
 */
public abstract class CCwantViewAware implements CCwantImageAware {
	 ...
	 */
	public CCwantViewAware(View view) {
		this(view, true);
	}
	 ...
	 *                            save memory.
	 */
	public CCwantViewAware(View view, boolean checkActualViewSize) {
	...
	public CCwantViewScaleType getScaleType() {
		return CCwantViewScaleType.CROP;
	}
