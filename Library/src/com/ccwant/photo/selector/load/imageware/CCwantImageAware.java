 ...
 * through {@link com.CCwantImageLoader.universalimageloader.core.ImageLoader ImageLoader}.
 ...
 * @see CCwantViewAware
 * @see CCwantImageViewAware
 * @see CCwantNonViewAware
 * @since 1.9.0
 */
public interface CCwantImageAware {
	...
	/**
	 * Returns {@linkplain com.CCwantViewScaleType.universalimageloader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * Also can be called in {@link com.CCwantBitmapDisplayer.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.CCwantBitmapDisplayer.universalimageloader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
