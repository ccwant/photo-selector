...
public class CCwantNonViewAware implements CCwantImageAware {
	...
	public CCwantNonViewAware(CCwantImageSize imageSize, CCwantViewScaleType scaleType) {
		this(null, imageSize, scaleType);
	}

	public CCwantNonViewAware(String imageUri, CCwantImageSize imageSize, CCwantViewScaleType scaleType) {
