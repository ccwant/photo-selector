 ...
 * @since 1.9.0
 */
public class CCwantImageViewAware extends CCwantViewAware {
	 ...
	 */
	public CCwantImageViewAware(ImageView imageView) {
		super(imageView);
	}
	 ...
	 *                            <p/>
	 */
	public CCwantImageViewAware(ImageView imageView, boolean checkActualViewSize) {
	...
	public CCwantViewScaleType getScaleType() {
		ImageView imageView = (ImageView) viewRef.get();
		if (imageView != null) {
			return CCwantViewScaleType.fromImageView(imageView);
		}
