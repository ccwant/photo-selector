 ...
 * @since 1.9.1
 */
public class CCwantRoundedVignetteBitmapDisplayer extends CCwantRoundedBitmapDisplayer {

	public CCwantRoundedVignetteBitmapDisplayer(int cornerRadiusPixels, int marginPixels) {
