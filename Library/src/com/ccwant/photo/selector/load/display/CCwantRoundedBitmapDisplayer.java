 ...
 * @since 1.5.6
 */
public class CCwantRoundedBitmapDisplayer implements CCwantBitmapDisplayer {

	protected final int cornerRadius;
	protected final int margin;

	public CCwantRoundedBitmapDisplayer(int cornerRadiusPixels) {
		this(cornerRadiusPixels, 0);
	}

	public CCwantRoundedBitmapDisplayer(int cornerRadiusPixels, int marginPixels) {
	...
	public void display(Bitmap bitmap, CCwantImageAware imageAware, CCwantLoadedFrom loadedFrom) {
		if (!(imageAware instanceof CCwantImageViewAware)) {
